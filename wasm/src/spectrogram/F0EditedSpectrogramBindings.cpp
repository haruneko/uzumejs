...
EMSCRIPTEN_BINDINGS(F0EditedSpectrogramBindings) {
    enum_<uzume::vocoder::SynthType>("SynthType")
        .value("Linear", uzume::vocoder::SynthType::Linear)
        .value("Log", uzume::vocoder::SynthType::Log)
        ;
    class_<uzume::vocoder::F0EditedSpectrogram, base<uzume::vocoder::Spectrogram>>("F0EditedSpectrogram")
        ...
        .constructor(&std::make_shared<uzume::vocoder::F0EditedSpectrogram, const uzume::vocoder::Spectrogram *, const uzume::vocoder::ControlChange &, uzume::vocoder::SynthType>, allow_raw_pointers())
